...
class ProdConfig(Config):
    ...
    MIN_INTERVAL_BETWEEN_SITTING_REMINDERS=os.getenv('MIN_INTERVAL_BETWEEN_SITTING_REMINDERS', 'secret')
    MIN_INTERVAL_BETWEEN_POSTURE_REMINDERS=os.getenv('MIN_INTERVAL_BETWEEN_POSTURE_REMINDERS', 'secret')
